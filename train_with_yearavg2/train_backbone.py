...
for 품목명 in pbar_outer:
    ...
    for epoch in range(CFG.epoch):
        ...
        if val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), f'backbone_models/best_model_{품목명}.pth')
    ...
    ### 추론
    model.load_state_dict(torch.load(f'backbone_models/best_model_{품목명}.pth', map_location=device))
...
# 결과 저장
sample_submission.to_csv('./backbone_train.csv', index=False, encoding='utf-8')
